 ...
 <table width="600" cellspacing="0" cellpadding="2" align = "center">
  ...
  <tr> 
   ...
   <td  style="padding:0 0 0 10" height="25"> 
    <input width="206" type=text name=city value="" class="input_style1">
   </td>
  ...
  <tr> 
   ...
   <td width="494" style="padding:0 0 0 10" height="25"> 
    <input type='password' name='passwd'  class="input_style1"><br>(정확한 비밀번호를 입력해야만 수정이 됩니다.)
   </td>
  </tr>
  <tr> 
   ...
   <td colspan="2" align="right"> 
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
     <tr> 
      ...
      <td width="12%"><A href="list01.jsp"> <img src="image/list.jpg" border=0></a></td>
     </tr>
    </table>
   </td>
  </tr>
