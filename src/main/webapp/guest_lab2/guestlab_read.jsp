...
%>
	...
	<table width='600' cellspacing='0' cellpadding='2' align='center'>
			   ...
			   <td width='51%' height='7'>글쓴이 : <%= rs.getString("ename") %> </td>
			   ...
			   <tr>
			   <td width='13%'></td>
			   <td width='25%'>지역 : <%= rs.getString("addr") %></td>
			   <td width='11%'></td>
			   </tr>
			   </table>
   ...
   <table width="600" border="0" cellpadding="0" cellspacing="5">
	<tr> 
		<td align="right" width="1850"><A href="guestlab_list.jsp?go=<%= request.getParameter("page")%>"><img src="images/list.jpg" border=0></a></td>
		<td width="100" align="right"><A href="guestlab_upd.jsp?id=<%= id %>&page=<%= request.getParameter("page") %>"><img src="images/edit.jpg" border=0></A></td>

		<td width="100" align="right"><A href="guestlab_del.jsp?id=<%= id %>&page=<%= request.getParameter("page") %>"><img src="images/del.jpg" border=0></A></td>
	</tr>
  </table>
